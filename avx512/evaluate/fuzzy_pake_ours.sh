...
./build/fuzzy_pake "$L" "$W" "$b" "$T" "$Q" 2>&1 >evaluate/anike/tmp.txt | tee evaluate/anike/ours_fuzzy_pake_${L}_${W}_${b}_${T}_${Q}_stderr.txt

mv evaluate/anike/tmp.txt evaluate/anike/ours_fuzzy_pake_${L}_${W}_${b}_${T}_${Q}_stdout.txt
