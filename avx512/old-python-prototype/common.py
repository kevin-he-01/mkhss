...
if __name__ == "__main__":
    test_gen_generator(generate_generator, prime_len = 1536, w = 1)
    test_gen_generator(generate_generator, prime_len = 1536, w = 5)
    prime_len = 1536
    w = 5
    # benchmark_gen_generator(generate_generator, prime_len, w)
    # benchmark_gen_generator(generate_generator_sagemath, prime_len, w)
