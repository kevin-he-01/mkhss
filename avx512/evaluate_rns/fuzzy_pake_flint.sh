...
./build/fuzzy_pake "$L" "$W" "$b" "$T" "$Q" 2>&1 >evaluate_rns/anike/tmp.txt | tee evaluate_rns/anike/flint_fuzzy_pake_${L}_${W}_${b}_${T}_${Q}_stderr.txt

mv evaluate_rns/anike/tmp.txt evaluate_rns/anike/flint_fuzzy_pake_${L}_${W}_${b}_${T}_${Q}_stdout.txt
