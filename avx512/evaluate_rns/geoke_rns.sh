...
./build/rns_location_anike "$L" "$D" 2>&1 >evaluate_rns/anike/tmp.txt | tee evaluate_rns/anike/rns_location_${L}_${D}_stderr.txt

mv evaluate_rns/anike/tmp.txt evaluate_rns/anike/rns_location_${L}_${D}_stdout.txt
