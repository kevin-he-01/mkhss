...
./build/baseline_fuzzy_pake "$L" "$W" "$b" "$T" "$Q" 2>&1 >evaluate/anike/tmp_${L}_${W}_${b}_${T}_${Q}.txt | tee evaluate/anike/baseline_fuzzy_pake_${L}_${W}_${b}_${T}_${Q}_stderr.txt

mv evaluate/anike/tmp_${L}_${W}_${b}_${T}_${Q}.txt evaluate/anike/baseline_fuzzy_pake_${L}_${W}_${b}_${T}_${Q}_stdout.txt
